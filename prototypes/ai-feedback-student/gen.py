...
def p_detail(S, L):
    ...
    (a link to its settings) — PM, 24 Sep; the 'Visible to students as' paper was removed the same day — plus a way into the dashboard.
