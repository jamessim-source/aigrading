...
JA = dict(
    ...
    ai_chip="AIフィードバック対応", progress="全16回 ・ 第7回まで公開", book="教材：地域環境統計学 テキスト（2026年度）",
    t71="7-1　相関分析", t72="7-2　仮説検定", t61="6-1　相関と外れ値", t81="8-1　回帰分析", lt_video="動画", lt_doc="資料", lt_file="ファイル", lt_fb="AIフィードバック",
    ...
    lo_fb7="第7回 演習 の AIフィードバック", lo_fb_s="提出した演習レポートへのコメント",
    chip_notsub="未提出 ・ 11月13日まで",
    lo_fb6="第6回 演習 の AIフィードバック",
    lo_ref6="第6回 週のふりかえり の AIフィードバック", lo_ref_s="300字のふりかえり",
    chip_returned="返却済み",
    lo_fb8="第8回 演習 の AIフィードバック", lo_fb8_s="開始日になると「やること」に表示されます", chip_pre="開始前",
    ...
    a_crit_h="コメントの観点", a_crit_note="採点は先生が行います。AI は点数をつけません。",
    a_boundary="AI は答えを書きません。質問と指摘だけを返します。",
    ...
    f_jump="本文の該当箇所を見る",
    # resubmit
    r_title="第7回 演習 の AIフィードバック ― 2回目の提出", r_h="2回目の提出", r_due="11月20日 23:59 まで",
    ...
    t_ref7="第7回 週のふりかえり の AIフィードバック", t_ref7_when="11月12日 提出",
    ...
    titles={"course":"コース — 地域環境統計学","assign":"課題 — 答案を提出する","pending":"提出済み — 先生の確認待ち","fb":"AIフィードバック — 返却済み",
            "resub":"2回目の提出","pending2":"2回目 提出済み — 先生の確認待ち","fb2":"AIフィードバック — 2回目 返却済み","todo":"やること"},
)
...
EN = dict(
    ...
    ai_chip="AI Feedback enabled", progress="16 sessions · through Session 7 published", book="Book: Regional & Environmental Statistics — Textbook (2026)",
    t71="7-1 · Correlation analysis", t72="7-2 · Hypothesis testing", t61="6-1 · Correlation and outliers", t81="8-1 · Regression", lt_video="Video", lt_doc="Document", lt_file="File", lt_fb="AI Feedback",
    ...
    lo_fb7="AI Feedback · Session 7 exercise", lo_fb_s="Comments on your submitted exercise report",
    chip_notsub="Not submitted · due Nov 13",
    lo_fb6="AI Feedback · Session 6 exercise",
    lo_ref6="AI Feedback · Session 6 weekly reflection", lo_ref_s="300-character reflection",
    chip_returned="Returned",
    lo_fb8="AI Feedback · Session 8 exercise", lo_fb8_s="Appears in To-do on its start date", chip_pre="Not started",
    ...
    a_crit_h="What the comments cover", a_crit_note="Your teacher grades. The AI does not give a score.",
    a_boundary="The AI never writes your answer. It only asks questions and points things out.",
    ...
    r_title="AI Feedback · Session 7 exercise — Second submission", r_h="Second submission", r_due="Due Nov 20, 23:59",
    ...
    t_ref7="AI Feedback · Session 7 weekly reflection", t_ref7_when="Submitted Nov 12",
    ...
    titles={"course":"Courses — Regional & Environmental Statistics","assign":"Assignment — Submit your work","pending":"Submitted — Awaiting teacher review","fb":"AI Feedback — Returned",
            "resub":"Second submission","pending2":"2nd submission — Awaiting teacher review","fb2":"AI Feedback — 2nd submission returned","todo":"To-do"},
)
