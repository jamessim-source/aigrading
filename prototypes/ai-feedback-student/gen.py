...
TJA = dict(
    ...
    t_ind_cols=["チャプター名", "トピック名", "学習日", "平均スコア", "完了"], t_sub_cols=["学習目標", "最終提出", "最新スコア", "最高スコア", "状態", "コメント", "観点", ""],
...
TEN = dict(
    ...
    t_ind_cols=["Chapter Name", "Topic Name", "Study Date", "Average Score", "Completion"], t_sub_cols=["Learning Objective", "Latest Submission", "Latest Score", "Highest Score", "Status", "Comments", "Criteria", ""],
        ...
        if open_:
            def fb_cells(n, a, b):
                ...
                if not det:
                    ...
                    return f'<td>{done}</td><td>{dd}</td><td>{dd}</td><td></td>'
