...
TJA = dict(
    ...
    t_tp_more="詳しく", t_tp_less="閉じる", t_tp_ins_lbl="今週の見落とし", t_tp_search="チャプター名・トピック名で検索",
...
TEN = dict(
    ...
    t_tp_more="Details", t_tp_less="Close", t_tp_ins_lbl="What the class missed", t_tp_search="Search by Chapter Name or Topic Name",
