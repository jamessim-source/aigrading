...
TJA = dict(
    ...
    t_rubric_h="評価基準", t_rubric_by="AIが生成 ・ LaTeX",
...
TEN = dict(
    ...
    t_rubric_h="Rubric", t_rubric_by="Generated by AI · LaTeX",
  ...
  <div style="display:flex;flex-direction:column;gap:16px">
    ...
    <div class="tpaper">
      ...
      <div class="pb"><p class="helper" style="margin:0 0 12px">{S["t_crit_note"]}</p>
        <div class="trubric"><h5>{S["t_rubric_h"]}<span class="tchip filled" style="font-family:Roboto,'Noto Sans JP',sans-serif;font-weight:400">{mi("spark", 12)}{S["t_rubric_by"]}</span></h5><ol>{rubric}</ol></div></div>
    </div>
  </div>
</div>
