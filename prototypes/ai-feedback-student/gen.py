...
def t_dash_group(S, L):
    ...
    b3 = (f'<div class="blk s2"><h4>{mi("rateReview", 14)}{G["b3_h"]}</h4><span class="helper" style="margin:0">{G["b3_lo"]}</span>'
    ...
    b4 = (f'<div class="blk s2"><h4>{mi("autorenew", 14)}{G["b4_h"]}</h4><span class="helper" style="margin:0">{G["b4_lo"]}</span>'
    ...
    overview = f'''<div class="tpaper"><div class="ph"><div><h3>{G["h"]}</h3><span class="helper" style="margin:2px 0 0">{G["sub"]}</span></div></div>
      <div class="pb" style="padding:16px"><div class="gd">{b3}{b4}{b5}</div></div></div>'''
