...
def t_dash_group(S, L):
    ...
    b2 = (f'<div class="blk s3 hot"><h4>{mi("schedule", 14)}{G["b2_h"]}</h4>' + "".join(brow(*r) for r in G["b2_rows"])
    ...
    overview = f'''<div class="tpaper"><div class="ph"><div><h3>{G["h"]}</h3><span class="helper" style="margin:2px 0 0">{G["sub"]}</span></div></div>
      <div class="pb" style="padding:16px"><div class="gd">{b2}{b5}{b3}{b4}</div></div></div>'''
